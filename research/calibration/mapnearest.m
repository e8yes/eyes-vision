...
% if there were any corners we failed to detect, the distance will be high
% replace them with our guess of where the point was instead of the rounded
% location.
outliers = find(val.^0.5 > 20);  %within 20 pixels?
Xround(outliers,:) = X(outliers,:);
