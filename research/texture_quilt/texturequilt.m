...
imagefile = 'img/wall_texture_small.png';
ntilesout = [40 40];   % how many tiles wide and tall the output should be
tilesize = 10;    % the size of the tiles we paste down (assumed square)
